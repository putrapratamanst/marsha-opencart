...
class ControllerExtensionThemeDefault extends Controller {
	...
	public function index() {
		$this->load->language('extension/theme/beautiqa');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/theme/beautiqa', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $this->request->get['store_id'], true)
		);

		$data['action'] = $this->url->link('extension/theme/beautiqa', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $this->request->get['store_id'], true);
		...
		$this->response->setOutput($this->load->view('extension/theme/beautiqa', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/theme/beautiqa')) {
